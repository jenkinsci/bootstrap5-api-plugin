...
@AnalyzeClasses(packages = "io.jenkins.plugins.bootstrap5", importOptions = DoNotIncludeTests.class)
class PackageArchitectureTest {
    ...
    static final ArchRule ADHERES_TO_PACKAGE_DESIGN
            ...
            consideringOnlyDependenciesInAnyPackage("io.jenkins.plugins.fontawesome")));
}
